        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 lg:gap-16 items-center py-16 sm:py-20 lg:py-28">
          ...
          <div className="text-center lg:text-left mt-12 lg:mt-0">
            ...
            <p className="mt-6 text-lg text-gray-300 max-w-xl mx-auto lg:mx-0">
              Your one-stop destination for elite gaming accessories. We're
              passionate about providing the gear that gives you a competitive
              edge and elevates your entire gaming experience.
            </p>
          ...
          <div>
            <div className="relative group">
              <div
                className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-xl blur-lg opacity-40 
                                         transition-all duration-500 group-hover:opacity-75 group-hover:-inset-2"
              ></div>
              <div
                className="relative p-1 bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 rounded-xl shadow-2xl 
